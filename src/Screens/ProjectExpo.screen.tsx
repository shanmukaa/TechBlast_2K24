...
export default function ProjectExpo() {
  return (
    <ScrollView>
      <Text style={{fontFamily:"Montserrat-Bold", color:"#000000",fontSize:25,marginTop:'10%',marginLeft:'5%'}}>Project Expo</Text>
      <View style={{flex:1,justifyContent:'center',alignContent:'center',marginTop:20}}>
      <Image source={require('../../assets/images/Project.jpg')} style={{width:undefined, height:200,resizeMode:'center',borderRadius:20}}/>
      </View>
...
In the coding ocean, solutions congeal.
      ...
      <Pressable onPress={ ()=>{ Linking.openURL('https://docs.google.com/forms/d/e/1FAIpQLSfggCyH39hPPaBWfn25vmpvIwEYR8HYct6YMNfrKpM45Zdm8Q/viewform')}} style={{ elevation: 10,backgroundColor: "#A2A0F6",borderRadius: 10,width:'50%',height:35,display:"flex",justifyContent:'center',alignItems:'center'}}>
